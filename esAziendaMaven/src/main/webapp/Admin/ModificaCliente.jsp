							...
							<font size="4" color="red"><%=messaggio.getMessaggio()%></font>
								<form class="form-horizontal" action="doRegistraCliente.jsp"
									...
									<div class="form-group">
										<label>Nome</label><br> <input type="text" id="nome1" ><br> 
										<label>Cognome</label><br><input type="text" id="cognome1"><br> 
										<label>Username</label><br> <input type="text" id="username1" ><br>
										<label>Password</label><br> <input type="text" id="password1"><br>
										<label>Ragione Sociale</label><br> <input type="text" id="ragioneSociale1"><br> 
										<label>PartitaIva</label><br><input type="text" id="pIva1" ><br> 
